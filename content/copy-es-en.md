...
| Vida, incapacidad a corto y largo plazo | Life, short- and long-term disability |
| Retiro y beneficios voluntarios | Retirement and voluntary benefits |
| Cumplimiento, ACA y comunicación al empleado | Compliance, ACA and employee communication |
| Hablar de beneficios → | Talk about benefits → |
| Lo que sostiene al negocio de pie | What keeps the business standing |
| En una isla que se pone a prueba cada temporada, la cobertura correcta se define en abril — no se descubre en septiembre. | On an island tested every season, the right coverage is settled in April — not discovered in September. |
...
| Leemos sus pólizas actuales antes de proponer nada. La mayoría de las brechas ya están escritas ahí — solo que nadie las ha leído en voz alta. | We read your current policies before proposing anything. Most of the gaps are already written there — nobody has read them out loud. |
| Diseño y colocación | Design and placement |
| Negociamos con múltiples carriers y usted ve el abanico completo, con sus diferencias reales — no solo la opción que a nosotros nos convenga colocar. | We negotiate with multiple carriers and you see the full range with its real differences — not just the option that suits us to place. |
| Renovación y reclamación | Renewal and claims |
| El trabajo real empieza después de firmar. Acompañamos cada reclamación y llegamos a la renovación con datos, no con una carta de aumento. | The real work starts after signing. We walk through every claim and arrive at renewal with data, not with an increase letter. |
| La firma | The firm |
...
| Tema | Topic |
| Commercial P&C | Commercial P&C |
| Los dos | Both |
| Contexto (opcional) | Context (optional) |
| Enviar solicitud | Send request |
| Al enviar se abre su correo con el mensaje redactado. Conectar a un CRM o formulario real antes de publicar. | Submitting opens your mail client with the message drafted. Connect to a CRM or real form endpoint before going live. |
| Oficina | Office |
| Teléfono | Phone |
| Correo | Email |
| Horario | Hours |
...
**El titular es la apuesta.** «El seguro se prueba en un solo día» dice algo verdadero y específico de la categoría en lugar de vender confianza genérica. Reencuadra todo lo demás —cotización, renovación, papeleo— como preparación para ese día. No lo suavices.
...
**La prueba de la copy.** Si una frase podría estar en la página de cualquier otro corredor de la isla, se reescribe.

**Lo que no se dice.** Nada de «su tranquilidad es nuestra prioridad», «soluciones integrales a la medida», ni «comprometidos con usted». La marca vende criterio, no tranquilidad.
